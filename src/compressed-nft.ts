...
import {
  TokenStandard
} from "@metaplex-foundation/mpl-bubblegum/dist/src/generated/types/TokenStandard";
import {
  TokenProgramVersion
} from "@metaplex-foundation/mpl-bubblegum/dist/src/generated/types/TokenProgramVersion";
import {ePrint, kits} from "./kits";
import BN from "bn.js";

export const HELIUS_RPC = "https://devnet.helius-rpc.com/?api-key=1a5deb03-d4bc-4b7a-b423-58d92148c0fe";
...
export module cNFT {
  ...
  export async function getAssetId(tree: PublicKey | string, index: number | string | BN): Promise<PublicKey> {
    return await getLeafAssetId(toKey(tree), index instanceof BN ? index : new BN.BN(index));
  }
  ...
  export async function createCompressedTree(maxDepthSizePair: ValidDepthSizePair,
    ...
    kits.printExplorerUrl(treeKeypair.publicKey.toBase58())
